...
import { ItemCreateDTO, ItemFilterCriteriaRequest, ItemResponseDTO, PageResponse } from '../models';
...
export class ItemService {
  ...
  createItem(itemCreateDTO: ItemCreateDTO): Observable<ItemResponseDTO> {
    return this.httpClient.post<ItemResponseDTO>(this.BASE_API_PATH, itemCreateDTO);
  }
}
